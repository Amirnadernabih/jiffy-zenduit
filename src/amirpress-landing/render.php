<?php
$template_path = SWORDHEALTH_ORG_ROOT . '/inc/templates/amirpress.html';
...
$content_start = strpos($template, '<div class="amirpress-wrapper">');
...
$content = str_replace('./assets/', $assets_base, $content);
$script = str_replace('./assets/', $assets_base, $script);
?>
